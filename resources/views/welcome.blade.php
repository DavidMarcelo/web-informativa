                ...
                <div class="carousel-inner">
                    ...
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <form id="myForm" action="/send/mail" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nombre" name="name" placeholder="Nombre completo" required>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-6">
                                                    ...
                                                    <input type="number" class="form-control" id="telefono" name="phone" placeholder="Número telefonico" required>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="necesita" class="form-label negro">¿Cuánto necesitas?</label>
                                                <input type="number" class="form-control" id="necesita" name="money" placeholder="Desde $30,000.00 a $5,000,000.00">
                                            </div>
                                            <div class="mb-3">
                                                <label for="plazo" class="form-label negro">¿A qué plazo quieres pagarlo?</label>
                                                <input type="number" class="form-control" id="email" name="plazo" placeholder="Plazo 3 (meses)" required>
                                            </div>
                                            <div class="form-floating mensajeForm">
                                                <textarea class="form-control" placeholder="Escriba un mensaje..." id="mensaje" name="comentario"></textarea>
                            ...
                            <a href="https://walink.co/ef8d74" class="btn btn-circle btn-lg fixed btnCircleIzq">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    style="background: #E8E8E8; padding-bottom: 50px;">
                        ...
                        <a href="#inicio" type="button" class="btn btn-outline-secondary padingTop">Solicitar Más Información</a>
                    </div>
